...
model = FCNN(device=device, guess=True)
...
run3d.run(device, train_dataset, valid_dataset, test_dataset, model, loss_func, evaluation,
          epochs=10, batch_size=32, vt_batch_size=32, lr=0.001, lr_decay_factor=0.5, lr_decay_step_size=1,
          energy_and_force=False, p=None, save_dir='guess_save_dir', log_dir='guess_log_dir')